...
export const SidebarLessonsItem = ({ courseId, lesson, moduleSlug }) => {
    ...
    return (
        <Link
            ...
            className={cn(
                ...
                isPrivate(lesson) ? "text-slate-700  hover:text-slate-700 cursor-default" : isComplete(lesson) && "text-emerald-700 hover:text-emerald-700"
            )}
        >
